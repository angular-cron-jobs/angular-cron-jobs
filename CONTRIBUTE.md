...
First of all, thank you for considering to contribute to the Angular Cron Jobs project.
...
9. Add a new [Release in GitHub](https://github.com/angular-cron-jobs/angular-cron-jobs/releases)
